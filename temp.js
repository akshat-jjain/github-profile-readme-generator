...
const generate = () => {
    ...
    const top_skills = ($id('top-skills').checked && input_check('github-username')) ? `<p><img align="left" src="https://github-readme-stats.vercel.app/api/top-langs?username=${github}&show_icons=true&locale=en&layout=compact&langs_count=10" alt="${github}" /></p>` : "";
